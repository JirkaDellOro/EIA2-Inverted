...
(function (eiaSteroids) {
    ...
    function createPaths() {
        eiaSteroids.asteroidPaths = createAsteroidPaths(eiaSteroids.shapesAsteroids);
        eiaSteroids.ufoPath = createUfoPath();
    }
    eiaSteroids.createPaths = createPaths;
