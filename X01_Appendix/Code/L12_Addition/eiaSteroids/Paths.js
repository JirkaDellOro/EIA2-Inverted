...
(function (L12_eiaSteroids) {
    L12_eiaSteroids.shapesAsteroids = [
        [
    ...
    function createPaths() {
        L12_eiaSteroids.asteroidPaths = createAsteroidPaths(L12_eiaSteroids.shapesAsteroids);
        L12_eiaSteroids.ufoPath = createUfoPath();
    }
    L12_eiaSteroids.createPaths = createPaths;
